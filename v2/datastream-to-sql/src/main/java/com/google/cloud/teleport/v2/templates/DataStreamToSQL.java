...
public class DataStreamToSQL {
  ...
  public interface Options extends PipelineOptions, StreamingOptions {
    ...
    @TemplateParameter.Text(
        ...
        helpText =
            "(description=(retry_count=)(retry_delay=)(address=(protocol=(()()())(connect_data=....")
    ...
    @TemplateParameter.Text(
        ...
        optional = true,
        description = "Custom connection string.",
        helpText = "Database Type (postgres or mysql)")
    @Default.String("postgres")
    ...
    @TemplateParameter.Text(
        ...
        helpText = "Sercret Name Source DB")
  ...
  public static CdcJdbcIO.DataSourceConfiguration getDataSourceConfiguration(Options options) {
    ...
    switch (options.getDatabaseType()) {
      ...
      case "oracle":
        ...
        jdbcDriverConnectionString =
            String.format("jdbc:oracle:thin:@%s", options.getDatabaseHost());
        break;
      default:
  ...
  public static CdcJdbcIO.DataSourceConfiguration getDataSourceSourceConfiguration(
      Options options) {
    String jdbcDriverName;
    String jdbcDriverConnectionString;
    ...
    jdbcDriverConnectionString =
        String.format(
            "jdbc:postgresql://%s:%s/%s",
            options.getSourceDatabaseHost(),
            options.getSourceDatabasePort(),
            options.getSourceDatabaseName());
  ...
  public static PipelineResult run(Options options) {
    ...
    // Postgres
    CdcJdbcIO.DataSourceConfiguration sourceDataSourceConfiguration =
        getDataSourceSourceConfiguration(options);
     ...
     */
    CdcJdbcIO.Write<KV<String, DmlInfo>> kvWrite =
            ...
            .withStatementFormatter(
                new CdcJdbcIO.StatementFormatter<KV<String, DmlInfo>>() {
                  public String formatStatement(KV<String, DmlInfo> element) {
                    LOG.info(
                        "SQL writing : Element key for table : {} {}",
                        element.getValue().getPrimaryKeyValues(),
                        element.getValue().getTableName());
